...
import { abilitySlotLabel, categoryLabel, entityLabel, growthRateLabel, pokemonDetailStatLabel, pokemonTypePresentation, statLabel, traceLabel, typeLabel } from '../../../src/lib/presentation/labels.ts'
